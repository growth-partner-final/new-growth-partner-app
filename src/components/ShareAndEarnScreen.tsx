...
export const ShareAndEarnScreen: React.FC<ShareAndEarnScreenProps> = ({
  ...
  return (
    <div className="bg-[#fcf9f4] font-sans text-[#1c1c19] flex flex-col min-h-full relative">
      {/* Main Content Area */}
      <main className="flex flex-col relative w-full pt-6 px-4 sm:px-8 lg:px-12 mx-auto space-y-6 pb-24">
        ...
        {/* Responsive Edge-to-Edge Grid for Desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full items-start">
          {/* Left Column: Code Hero Card, Outreach Channels, and Script */}
          ...
          {/* Right Column: In-Store QR Scanner & Live Telemetry Module */}
