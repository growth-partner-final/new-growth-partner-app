...
export const MILESTONE_LEVELS: MilestoneLevel[] = [
  {
    id: 'l1',
    level: 1,
    name: 'Level 1: 25 Shops',
    subtitle: 'Official Starter Kit',
    rewardGift: 'Official Nexora T-Shirt',
    perks: 'Certified Partner Badge + Welcome Merchandise Kit',
    clientsRequired: 25,
  ...
  },
  {
    id: 'l2',
    level: 2,
    name: 'Level 2: 50 Shops',
    subtitle: 'Smart Tablet Milestone',
    rewardGift: 'Samsung Tablet',
    perks: 'Samsung Galaxy Tab A9+ with Nexora OS preloaded',
    clientsRequired: 50,
    colorClass: 'bg-secondary-container/60 text-primary-container',
    icon: 'tablet_mac'
  },
  {
    id: 'l3',
    level: 3,
    name: 'Level 3: 100 Shops',
    subtitle: 'Productivity Hardware Milestone',
    rewardGift: 'Branded HP Laptop',
    perks: 'HP Enterprise Core i5 Laptop + Priority Tech Desk',
    clientsRequired: 100,
    colorClass: 'bg-secondary-container/60 text-primary-container',
    icon: 'laptop_mac'
  },
  {
    id: 'l4',
    level: 4,
    name: 'Level 4: 250 Shops',
    subtitle: 'EV Smart Ride Milestone',
    rewardGift: 'Electric Scooter',
    perks: 'Brand New Smart Electric Scooter (Ather 450X / Ola S1 Pro)',
    clientsRequired: 250,
    colorClass: 'bg-secondary-container/60 text-primary-container',
  ...
  },
  {
    id: 'l5',
    level: 5,
    name: 'Level 5: 500 Shops',
    subtitle: 'Flagship Smartphone Milestone',
    rewardGift: 'Latest iPhone',
    perks: 'Latest Apple iPhone Flagship Edition + AppleCare+',
    clientsRequired: 500,
    colorClass: 'bg-secondary-container/60 text-primary-container',
    icon: 'smartphone'
  },
  {
    id: 'l6',
    level: 6,
    name: 'Level 6: 750 Shops',
    subtitle: 'Cruiser Motorcycle Milestone',
    rewardGift: 'Royal Enfield 350 CC',
    perks: 'Royal Enfield Classic 350 CC (On-Road Local Showroom Handover)',
    clientsRequired: 750,
  ...
  },
  {
    id: 'l7',
    level: 7,
    name: 'Level 7: 1000+ Shops',
    subtitle: 'District Partner Grand Vehicle Milestone',
    rewardGift: 'District Partner SUV Car',
    perks: 'Brand New Premium Partner SUV (Mahindra XUV700 / Creta Fund) + Lifetime Royalty',
